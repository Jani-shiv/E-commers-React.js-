      ...
      <div className="p-4">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="flex-1 bg-primary text-white py-2 px-4 rounded-md hover:bg-primary-dark disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors duration-200"
          >
